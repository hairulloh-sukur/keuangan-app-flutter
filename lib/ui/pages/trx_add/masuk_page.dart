...
class _MasukPageState extends State<MasukPage> {
  String valMataUang = '';
  // String tanggalMasuk = 'Pilih Tanggal';
  String tanggalMasuk = DateFormat.yMMMMd().format(DateTime.now());
                  ...
                  IconButton(
                    onPressed: () {
                      DatePicker.showDatePicker(context,
                        ...
                        setState(() {
                          tanggalMasuk = DateFormat.yMMMMd().format(date);
                        });
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      // print(
                      //     'outletId: $outletId - userId: $userId - pTipe: $pTipe - currId: $currId - nominal: $nominal - ket: $ket - outletId: $outletId - tgl: $tgl');

                      if (outletId1 != '' && tgl != '' && currId != '') {
