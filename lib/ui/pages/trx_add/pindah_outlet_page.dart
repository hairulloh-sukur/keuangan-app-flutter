...
class PindahOutletPage extends StatefulWidget {
  // const PindahOutletPage({Key? key}) : super(key: key);

  @override
  State<PindahOutletPage> createState() => _PindahOutletPageState();
}

class _PindahOutletPageState extends State<PindahOutletPage> {
  String valMataUang = '';
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      // print(
                      //     'outletId: $outletId - userId: $userId - pTipe: $pTipe - currId: $currId - nominal: $nominal - ket: $ket - outletId1: $outletId1 - outletId2: $outletId2 - tgl: $tgl');
